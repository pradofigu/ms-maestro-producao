...
public class TestingServiceScope 
{
    ...
    public async Task<TEntity> FindAsync<TEntity>(params object[] keyValues)
        where TEntity : class
    {
        var context = _scope.ServiceProvider.GetService<BackofficeDbContext>();
    ...
    {
        var dbContext = _scope.ServiceProvider.GetRequiredService<BackofficeDbContext>();
    ...
    public Task<T> ExecuteDbContextAsync<T>(Func<BackofficeDbContext, Task<T>> action)
