...
public class TestingWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        Environment.SetEnvironmentVariable($"{ConnectionStringOptions.SectionName}__{ConnectionStringOptions.BackofficeServiceKey}", _dbContainer.GetConnectionString());
